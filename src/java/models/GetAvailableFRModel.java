 ...
 * @author ManojKasun
 */
public class GetAvailableFRModel {
...
DbCon db = new DbCon();
    ...
    public GetAvailableFRModel() {
    try {
         
         String query = "select *from rooms where type LIKE 'Family Room'";
        ...
        count = count-1;
         try{
              String sql="UPDATE rooms SET count='"+count+"' where type LIKE 'Family Room'";
