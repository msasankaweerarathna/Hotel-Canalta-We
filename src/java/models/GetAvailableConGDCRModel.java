 ...
 * @author ManojKasun
 */
public class GetAvailableConGDCRModel {
 ...
 DbCon db = new DbCon();
    ...
    public GetAvailableConGDCRModel() {
       try {
         
         String query = "select * from rooms where type LIKE 'Grand Deluxe Conference Hall'";
    ...
    public boolean roomBook() throws ClassNotFoundException, SQLException{
        ...
        count = count-1;
         try{
              String sql="UPDATE rooms SET count='"+count+"' where type LIKE 'Grand Deluxe Conference Hall'";
