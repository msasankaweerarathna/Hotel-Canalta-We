 ...
 * @author ManojKasun
 */
public class GetAvailableGDRModel {
 ...
 DbCon db = new DbCon();
    ...
    public GetAvailableGDRModel() {
    try {
         
         String query = "select *from rooms where type LIKE 'Grand Deluxe Room'";
        ...
        count = count-1;
         try{
              String sql="UPDATE rooms SET count='"+count+"' where type LIKE 'Grand Deluxe Room'";
