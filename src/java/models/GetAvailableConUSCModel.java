 ...
 * @author ManojKasun
 */
public class GetAvailableConUSCModel {
 ...
 DbCon db = new DbCon();
    ...
    public GetAvailableConUSCModel() {
       try {
         
         String query = "select * from rooms where type LIKE 'Ultra Superior Conference Hall'";
    ...
    public boolean roomBook() throws ClassNotFoundException, SQLException{
        ...
        count = count-1;
         try{
              String sql="UPDATE rooms SET count='"+count+"' where type LIKE 'Ultra Superior Conference Hall'";
