 ...
 * @author ManojKasun
 */
public class GetAvailableCoupleRoomsModel {
    DbCon db = new DbCon();
    ...
    public GetAvailableCoupleRoomsModel() {
    try {
         
         String query = "select *from rooms where type LIKE 'Couple Room'";
     ...
     public boolean roomBook() throws ClassNotFoundException, SQLException{
        ...
        count = count-1;
         try{
              String sql="UPDATE rooms SET count='"+count+"' where type LIKE 'Couple Room'";
