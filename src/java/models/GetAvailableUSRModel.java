 ...
 * @author ManojKasun
 */
public class GetAvailableUSRModel {
 ...
 DbCon db = new DbCon();
    ...
    public GetAvailableUSRModel() {
    try {
         
         String query = "select *from rooms where type LIKE 'Ultra Superior Room'";
    ...
    public boolean roomBook() throws ClassNotFoundException, SQLException{
        ...
        count = count-1;
         try{
              String sql="UPDATE rooms SET count='"+count+"' where type LIKE 'Ultra Superior Room'";
