			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<h3 class="mb-4 text-center">Have an account?</h3>
                        <form action="../customerLoginController" method="POST" class="signin-form">
	          ...
	          <p class="w-100 text-center">&mdash; Or Sign Up Or back To Home &mdash;</p>
	          <div class="social d-flex text-center">
	          	<a href="../index.jsp" class="px-2 py-2 mr-md-1 rounded"><span class="ion-logo-home mr-2"></span> Home</a>
	          	<a href="signup.jsp" class="px-2 py-2 ml-md-1 rounded"><span class="ion-logo-add mr-2"></span> Sign Up</a>
	          </div>
		      </div>
				</div>
			</div>
